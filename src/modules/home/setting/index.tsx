...
const Setting: React.FunctionComponent<Props> = (props: Props) => {
    ...
    const toggleModalRestart = () => {
        setModalRestartVisible(!isModalRestartVisible && currentLanguage != languageActive);
    };
                ...
                <CustomModal
                    ...
                    <View style={styles.modal__footer}>
                        <LinkButton
                            ...
                            onClick={() => {toggleModalLanguage(); setLanguageActive(currentLanguage);}}
                            color={styleVars.greyColor}
                        />
                        <LinkButton
                            title={I18n.translate('changeLanguage.save')}
                            onClick={() => { toggleModalLanguage(); toggleModalRestart() }}
