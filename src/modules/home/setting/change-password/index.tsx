...
const ChangePassword: React.FunctionComponent<Props> = (props: Props) => {
    ...
    const validationSchema = Yup.object().shape({
        oldPassword: Yup.string()
            ...
            .required(
                I18n.translate('changePassword.oldPassword_requireError'),
            ).max(40),
        ...
        newPassword: Yup.string()
            ...
            .required(
                I18n.translate('changePassword.newPassword_requireError'),
            ),

        reNewPassword: Yup.string()
            .required(
                I18n.translate('changePassword.repeatNewPassword_requireError'),
            )
            .when('newPassword', {
                ...
                then: Yup.string().oneOf(
                    [Yup.ref('newPassword')],
                    I18n.translate(
                        'changePassword.repeatNewPassword_sameError',
                    ),
                ),
            }),
    });
                            ...
                            <Fragment>
                                <View>
                                    ...
                                    <TextInputGroup
                                        ...
                                        onBlur={() =>
                                            setFieldTouched('reNewPassword')
                                        }
                                        secureTextEntry={!isPasswordShown[2]}
                                        onToggleShowPassword={() =>
                                            toggleShowPassword(2)
                                        }
